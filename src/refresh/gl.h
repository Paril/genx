...
#define GL_INDEX_TYPE   GLuint
#define GL_INDEX_ENUM   GL_UNSIGNED_INT
...
#define GL_ClearDepth glClearDepth
#define GL_DepthRange glDepthRange
...
typedef struct
{
	...
	GL_INDEX_TYPE  indices[TESS_MAX_INDICES];
